...
function big_brother_google_fonts() {
	...
	if ( 'off' !== _x( 'on', 'Gentium font: on or off', 'big-brother' ) ) {
		...
		wp_register_style( 'big-brother-gentium', "$protocol://fonts.googleapis.com/css?family=Gentium+Basic:400,700,400italic,700italic&subset=latin,latin-ext" );

	}

	if ( 'off' !== _x( 'on', 'Open Sans font: on or off', 'big-brother' ) ) {

		wp_register_style( 'big-brother-open-sans', "$protocol://fonts.googleapis.com/css?family=Open+Sans:400,800&subset=latin,latin-ext" );
