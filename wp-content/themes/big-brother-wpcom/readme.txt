...
Donate link:
Tags: blue, light, right-sidebar, two-columns, custom-background, custom-header, custom-menu, full-width-template, post-formats, translation-ready, rtl-language-support, fixed-layout, responsive-layout
Tested up to: 4.0
Stable tag: 3.6
...
= Does Big Brother support widgets? =

Yes! You can add widgets under Appearance -> Widgets, and they will appear in the sidebar.

= Does Big Brother support Post Formats? =

Big Brother supports Aside, Image, Video, Quote, and Link post formats. Each is denoted with a unique symbol.
